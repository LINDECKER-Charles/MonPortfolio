...
const NAMESPACES = ['nav-barre', 'home-resume', 'home-projects', 'home-work', 'photo-carousel', 'projects', 'works', 'footer', 'construction', 'opening', 'common', 'resum', 'linktree'] as const;
